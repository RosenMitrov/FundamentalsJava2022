...
public class RemoveGivenIndex {
    public static void main(String[] args) {
        ...
        numbersArray = getArrayWithRemovedLastElement(numbersArray, givenIndex);
        System.out.print("New Array: ");
        printArray(numbersArray);

    }

    private static int[] getArrayWithRemovedLastElement(int[] numbersArray, int givenIndex) {
        ...
        for (int index = 0; index < tempArray.length; index++) {
            ...
            if (check == 1) {
                tempArray[givenIndex] = numbersArray[givenIndex + 1];
