package fund06ObjectsAndClasses.lab.definingSimpleClasses.P06StudentsConstructorTwo;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;

import static fund06ObjectsAndClasses.lab.definingSimpleClasses.P06StudentsConstructorTwo.StudentTwo.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        while (!input.equals("end")) {
            ...
            String city = data[3];
            StudentTwo currentStudent = new StudentTwo(firstName, lastName, age, city);
            if (isStudentExisting(studentTwoList, firstName, lastName)) {
                currentStudent = getStudent(studentTwoList, firstName, lastName, age, city);
            } else {
