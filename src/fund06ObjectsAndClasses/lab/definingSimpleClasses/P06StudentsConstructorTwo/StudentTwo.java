...
public class StudentTwo {
    ...
    StudentTwo(String firstName, String lastName, int age, String city) {
    ...
    public static StudentTwo getStudent(List<StudentTwo> studentTwoList, String firstName, String lastName, int age, String city) {
